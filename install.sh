#!/usr/bin/env sh
# Universal installer for personagraph. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/personagraph.git"
echo "Installing personagraph ..."
...
echo "Done. Run: personagraph --help"
